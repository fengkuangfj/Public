		...
		if (lpCmdResultInfo)
		{
			__try
			{
				while (TRUE)
				{
					...
					ulOutputReadSizeCh = _countof(tchStdOutputRead);
					if (!CStringInternal::ASCIIToUNICODE(tchStdOutputRead, &ulOutputReadSizeCh, chStdOutputRead, CP_ACP))
					{
