	...
	CStackBacktrace::WalkFrameChaim()
{
	...
	CSimpleLogSR(MOD_STACK_BACKTRACE, LOG_LEVEL_INFORMATION_STACK_BACKTRACE, "begin"); 
	...
	CSimpleLogSR(MOD_STACK_BACKTRACE, LOG_LEVEL_INFORMATION_STACK_BACKTRACE, "end"); 
